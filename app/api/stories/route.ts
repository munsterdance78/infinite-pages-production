  ...
  try {
    ...
    const { data: story, error: createError } = await (supabase as any)
      ...
      .insert({
        ...
        premise,
        foundation,
        target_length: requestBody.target_length || 50000,
        target_chapters: requestBody.target_chapters || 30,
        target_chapter_length: requestBody.target_chapter_length || 2000,
